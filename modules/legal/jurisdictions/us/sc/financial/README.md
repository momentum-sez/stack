# United States - South Carolina — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **United States - South Carolina** (`us-sc`).
