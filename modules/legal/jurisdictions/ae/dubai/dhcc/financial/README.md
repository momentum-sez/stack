# UAE - Dubai - Dubai Healthcare City (DHCC) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai Healthcare City (DHCC)** (`ae-dubai-dhcc`).
