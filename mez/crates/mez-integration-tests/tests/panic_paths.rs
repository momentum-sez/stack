...
// =========================================================================
// mez-core: Canonical + Digest panic paths
// =========================================================================
...
// =========================================================================
// mez-core: Identity type validation
// =========================================================================
...
// =========================================================================
// mez-corridor: NettingEngine panic paths
// =========================================================================
...
// =========================================================================
// mez-crypto: Ed25519 panic paths
// =========================================================================

use mez_crypto::{sha256_digest, Ed25519Signature, SigningKey};
...
// =========================================================================
// mez-crypto: CAS panic paths (filesystem-based)
// =========================================================================
...
// =========================================================================
// mez-crypto: MMR panic paths
// =========================================================================

use mez_crypto::MerkleMountainRange;
...
// =========================================================================
// mez-state: State machine invalid transition panic paths
// =========================================================================

use mez_state::{DynCorridorState, Entity, EntityLifecycleState, LicenseState, MigrationState};
...
// =========================================================================
// mez-corridor: SWIFT pacs.008 panic paths
// =========================================================================

use mez_corridor::swift::{SettlementInstruction, SettlementRail, SwiftPacs008};

#[test]
fn swift_generate_instruction_empty_bics() {
    // BUG-023: Empty BIC codes — should return error, never panic
    let swift = SwiftPacs008::new("MEZTEST");
...
// =========================================================================
// mez-vc: Credential signing/verification panic paths
// =========================================================================
...
// =========================================================================
// mez-arbitration: Dispute state transition panic paths
// =========================================================================

// =========================================================================
// mez-corridor: Fork resolution panic paths
// =========================================================================

use mez_corridor::fork::{resolve_fork, ForkBranch, ForkDetector};
use mez_corridor::WatcherRegistry;
...
// =========================================================================
// mez-corridor: Bridge routing panic paths
// =========================================================================
...
// =========================================================================
// mez-corridor: Receipt chain panic paths
// =========================================================================

use mez_corridor::receipt::{CorridorReceipt, ReceiptChain};
...
// =========================================================================
// mez-arbitration: EscrowAccount panic paths
// =========================================================================

use mez_arbitration::dispute::DisputeId;
...
// =========================================================================
// mez-arbitration: EnforcementOrder panic paths
// =========================================================================

use mez_arbitration::enforcement::{EnforcementAction, EnforcementOrder, EnforcementStatus};
...
// =========================================================================
// mez-agentic: Scheduler panic paths
// =========================================================================

use mez_agentic::policy::{AuthorizationRequirement, PolicyAction};
use mez_agentic::scheduler::{ActionScheduler, ScheduledAction as SchedAction};
...
fn scheduler_status_counts() {
    ...
    assert_eq!(
        *counts
            .get(&mez_agentic::scheduler::ActionStatus::Pending)
            .unwrap_or(&0),
        1
    );
    ...
    assert_eq!(
        *counts2
            .get(&mez_agentic::scheduler::ActionStatus::Completed)
            .unwrap_or(&0),
        1
    );
}

use mez_arbitration::dispute::DisputeState;
...
// =========================================================================
// mez-agentic: PolicyEngine panic paths
// =========================================================================

use mez_agentic::{PolicyEngine, Trigger, TriggerType};
...
fn deser_compliance_state_from_invalid_string_no_panic() {
    let result: Result<mez_tensor::ComplianceState, _> = serde_json::from_str("\"invalid\"");
...
// =========================================================================
// Campaign 2 Extension: mez-pack panic paths
// =========================================================================

use mez_pack::parser::ensure_json_compatible;
use mez_pack::regpack::{validate_compliance_domain, SanctionsChecker, SanctionsEntry};
...
// =========================================================================
// Campaign 2 Extension: mez-agentic panic paths
// =========================================================================
...
// =========================================================================
// Campaign 2 Extension: mez-corridor CorridorBridge panic paths
// =========================================================================
...
// =========================================================================
// Campaign 2 Extension: mez-vc panic paths
// =========================================================================

use mez_vc::registry::SmartAssetRegistryVc;
