# United States - American Samoa — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **United States - American Samoa** (`us-as`).
