# UAE - Dubai - Dubai Knowledge Park (DKP) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai Knowledge Park (DKP)** (`ae-dubai-dkp`).
