# UAE - Dubai - International Free Zone Authority (IFZA) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - International Free Zone Authority (IFZA)** (`ae-dubai-ifza`).
