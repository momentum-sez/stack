...
module.exports = function build_chapter25() {
  return [
    ...
    p("The three live and planned corridors represent Pakistan's three largest bilateral trade relationships, collectively accounting for $38.6B in annual trade volume. Each corridor operates at a different maturity level, allowing Momentum to validate the EZ Stack architecture progressively: the UAE corridor proves full orchestration at scale, the KSA corridor validates customs automation and diaspora services under a new bilateral framework, and the CHN corridor will stress-test the system against the most complex multi-EZ, multi-currency configuration in the portfolio."),
    table(
