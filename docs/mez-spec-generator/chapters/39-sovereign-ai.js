  ...
  return [
    ...
    table(
      ...
      [
        ...
        ["Transfer pricing manipulation", "PKR 150-400 billion", "Arm's-length pricing analysis on cross-border transactions within MEZ corridors; comparability analysis against market benchmarks", "10-20% of identified gap"],
