...
//! [`ComplianceDomain`] enum from `mez-core`
...
impl<J: JurisdictionConfig> ComplianceTensor<J> {
    ...
    ///
    /// Uses the `CanonicalBytes → ContentDigest` pipeline from `mez-core`,
    ...
    pub fn commit(&self) -> Result<TensorCommitment, mez_core::MezError> {
