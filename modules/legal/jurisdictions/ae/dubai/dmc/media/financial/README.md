# UAE - Dubai - Dubai Media City (DMC) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai Media City (DMC)** (`ae-dubai-dmc-media`).
