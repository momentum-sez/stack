...
fn make_corridor_lifecycle_vc(
    ...
    VerifiableCredential {
        ...
        issuer: "did:msez:corridor-authority".to_string(),
...
fn corridor_vc_lifecycle_transition() {
    ...
    vc.sign_ed25519(
        &sk,
        "did:msez:corridor-authority#key-1".to_string(),
...
fn corridor_vc_anchor_proof() {
    ...
    let mut vc = VerifiableCredential {
        context: ContextValue::Array(vec![json!("https://www.w3.org/2018/credentials/v1")]),
        id: Some("urn:msez:vc:corridor-anchor:corr-002".to_string()),
        credential_type: CredentialTypeValue::Array(vec![
            "VerifiableCredential".to_string(),
            "CorridorAnchorProof".to_string(),
        ]),
        issuer: "did:msez:anchor-service".to_string(),
        issuance_date: chrono::Utc::now(),
        expiration_date: None,
        credential_subject: json!({
    ...
    vc.sign_ed25519(
        &sk,
        "did:msez:anchor-service#key-1".to_string(),
...
fn corridor_vc_multi_jurisdiction() {
    ...
    let mut vc = VerifiableCredential {
        context: ContextValue::Array(vec![json!("https://www.w3.org/2018/credentials/v1")]),
        id: Some("urn:msez:vc:multi-corridor:trilateral".to_string()),
        credential_type: CredentialTypeValue::Array(vec![
            "VerifiableCredential".to_string(),
            "CorridorMultiJurisdiction".to_string(),
        ]),
        issuer: "did:msez:governance-council".to_string(),
        issuance_date: chrono::Utc::now(),
        expiration_date: None,
        credential_subject: json!({
    ...
    vc.sign_ed25519(
        &sk_sg,
        "did:msez:jurisdiction:SG-JURONG#key-1".to_string(),
        ProofType::Ed25519Signature2020,
        None,
    )
    .unwrap();
...
fn corridor_vc_tamper_detection() {
    ...
    vc.sign_ed25519(
        &sk,
        "did:msez:authority#key-1".to_string(),
        ProofType::Ed25519Signature2020,
        None,
    )
    .unwrap();
