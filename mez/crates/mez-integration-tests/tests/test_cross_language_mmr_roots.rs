...
//! the Rust `mez_crypto::mmr` module produces identical roots, peaks, leaf
//! hashes, and node hashes at every step.
//!
//! ## Fixture Source
//!
//! `tests/fixtures/mmr_roots.json` — generated by running the Python MMR
