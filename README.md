...
The kernel connects to Mass services over HTTP. In **sovereign mode**
(the default), Mass services are hosted by Momentum and your kernel calls
them remotely. In **full-stack mode**, you run Mass services locally
...
deploy/
  docker-compose.yaml    Sovereign mode deployment
schemas/
