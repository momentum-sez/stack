# UAE - Dubai - Dubai Silicon Oasis (DSO) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai Silicon Oasis (DSO)** (`ae-dubai-dso`).
