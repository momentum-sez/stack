# UAE - Abu Dhabi - Abu Dhabi Airports Free Zone (ADAFZ) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Abu Dhabi - Abu Dhabi Airports Free Zone (ADAFZ)** (`ae-abudhabi-adafz`).
