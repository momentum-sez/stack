# UAE - Dubai - Dubai World Trade Centre (DWTC) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai World Trade Centre (DWTC)** (`ae-dubai-dwtc`).
