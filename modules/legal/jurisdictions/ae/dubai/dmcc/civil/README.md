# UAE - Dubai - Dubai Multi Commodities Centre (DMCC) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Dubai - Dubai Multi Commodities Centre (DMCC)** (`ae-dubai-dmcc`).
