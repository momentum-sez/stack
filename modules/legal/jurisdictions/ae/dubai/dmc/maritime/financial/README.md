# UAE - Dubai - Dubai Maritime City — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai Maritime City** (`ae-dubai-dmc-maritime`).
