...
module.exports = function build_appendixG() {
  return [
    ...
    table(
      ...
      [
        ["Lawpack", "Income Tax Ordinance 2001 (ITO)", "Withholding tax schedules (sections 148\u2013156A), corporate tax rates, capital gains regimes, tax credits for SEZ entities, NTN binding requirements"],
        ["Lawpack", "Sales Tax Act 1990 (STA)", "Registration thresholds, input/output tax computation, zero-rating for exports, special procedures for SEZ supplies"],
        ...
        ["Lawpack", "Customs Act 1969", "Tariff classification, duty exemptions for SEZ inputs, bonded warehouse rules, transit trade provisions"],
        ...
        ["Lawpack", "Special Economic Zones Act 2012", "Zone developer obligations, one-window operation, 10-year tax exemptions, duty-free import provisions"],
        ...
        ["Licensepack", "BOI Approval", "Investment facilitation certificates, SEZ developer licenses, zone enterprise approvals, incentive eligibility tracking"],
