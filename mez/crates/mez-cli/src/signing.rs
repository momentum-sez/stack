...
//!
//! Wraps the `mez-crypto` Ed25519 module to provide CLI access to
...
/// Arguments for the `mez vc` (signing) subcommand.
#[derive(Args, Debug)]
...
pub enum SigningCommand {
    ...
    Keygen {
        ...
        output: PathBuf,
        /// Prefix for the key filenames (default: "mez").
        #[arg(long, default_value = "mez")]
        prefix: String,
