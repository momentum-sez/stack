# UAE - Dubai - Dubai Maritime City — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Dubai - Dubai Maritime City** (`ae-dubai-dmc-maritime`).
