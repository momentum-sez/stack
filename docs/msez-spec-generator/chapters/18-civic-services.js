...
pub enum EncumbranceKind {
    ...
    table(
      ...
      [
        ["1", "msez-tensor", "Evaluate compliance for buyer + jurisdiction", "Block transfer, issue compliance gap report"],
        ["2", "msez-pack (lawpack)", "Check transfer restrictions (foreign ownership, zoning)", "Block transfer, cite specific legal provision"],
        ["3", "msez-pack (regpack)", "Verify no sanctions hits on buyer or seller", "Block transfer, escalate to compliance officer"],
        ["4", "Title Registry", "Confirm all encumbrances cleared or subordinated", "Block transfer, list outstanding encumbrances"],
        ["5", "msez-mass-client (consent)", "Obtain required consents (lien holders, co-owners)", "Block transfer until consents obtained"],
        ["6", "msez-mass-client (ownership)", "Execute ownership mutation in Mass", "Rollback, no receipt appended"],
        ["7", "Receipt Chain", "Append transfer receipt to title's chain", "Retry with idempotency key"],
        ["8", "msez-vc", "Issue Transfer VC to buyer and seller", "Queue for async issuance"],
      ],
      [600, 2200, 3760, 2800]
    ),
    spacer(),
