# United States - District of Columbia — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **United States - District of Columbia** (`us-dc`).
