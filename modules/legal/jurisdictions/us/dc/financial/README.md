# United States - District of Columbia — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **United States - District of Columbia** (`us-dc`).
