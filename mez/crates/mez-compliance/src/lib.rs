//! # mez-compliance — Jurisdictional Compliance Bridge
//!
...
use mez_pack::regpack::{SanctionsChecker, SanctionsEntry};
use mez_tensor::ComplianceTensor;
...
mod tests {
    ...
    use mez_pack::regpack::SanctionsEntry;
    ...
    fn regpack_jurisdiction_narrows_applicable_domains() {
        let jid = JurisdictionId::new("pk-ez-01").unwrap();
    ...
    fn different_jurisdictions_produce_different_tensors() {
        let pk = RegpackJurisdiction::from_domain_names(
            JurisdictionId::new("pk-ez-01").unwrap(),
