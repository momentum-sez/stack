# United States - Rhode Island — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **United States - Rhode Island** (`us-ri`).
