...
module.exports = function build_chapter09() {
  return [
    ...
    ...codeBlock(
`/// A corridor receipt (mez-corridor::receipt)
...
pub struct CorridorReceipt {
    ...
    p("The proof field carries one or more Ed25519 signature objects conforming to the MezEd25519Signature2025 proof type. Multi-party signing is supported via the ReceiptProof::Multiple variant."),

    ...codeBlock(
`/// Proof: single object or array (mez-corridor::receipt)
#[serde(untagged)]
...
pub struct ProofObject {
    pub proof_type: String,            // "MezEd25519Signature2025"
    ...
    ...codeBlock(
`/// Append-only receipt chain with dual commitment (mez-corridor::receipt)
pub struct ReceiptChain {
    ...
    ...codeBlock(
`/// Compute next_root for a receipt (mez-corridor::receipt)
///
...
pub fn compute_next_root(receipt: &CorridorReceipt)
    ...
    ...codeBlock(
`/// Schema-conformant checkpoint (mez-corridor::receipt)
