# v0.4.33 — Smart-asset fork resolution
...
- `msez asset state verify --fork-resolutions <file-or-dir>`
- `msez asset state checkpoint --fork-resolutions <file-or-dir>`
- `msez asset state inclusion-proof --fork-resolutions <file-or-dir>`
...
- `msez asset state fork-resolve` (alias: `fork-resolution-init`)
...
- Added `contexts/msez/smart-asset/v1.jsonld`.
