...
- CLI:
  - `mez corridor state watcher-attest`
  - `mez corridor state fork-alarm`
- Spec updates:
...
- CLI:
  - `mez corridor availability-attest`
  - `mez corridor availability-verify`
- Spec updates:
...
- `tools/mez.py corridor state verify`:
