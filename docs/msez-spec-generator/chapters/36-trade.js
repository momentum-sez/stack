...
module.exports = function build_chapter36() {
  return [
    ...
    // --- 36.2 Module Specifications ---
    h2("36.2 Module Specifications"),

    // --- 36.2.1 Letters of Credit Module ---
    h3("36.2.1 Letters of Credit Module"),
    ...
    // --- 36.2.5 Trade Insurance Module ---
    h3("36.2.5 Trade Insurance Module"),
