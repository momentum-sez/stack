  ...
  return [
    ...
    table(
      ...
      [
        ...
        ["BOI", "Industrial licenses, EZ registrations", "Investment thresholds, sector restrictions, incentive eligibility"],
    ...
    table(
      ...
      [
        ...
        ["Mixed", "Multi-domain licenses spanning categories", "EZ developer license (corporate + trade + financial)"],
      ],
      [1400, 3160, 4800]
    ),
    ...codeBlock(
    ...
    p("Three JSON schemas define the complete licensepack structure. These schemas are part of the 116 schemas in mez-schema and are validated at pack build time, pack load time, and before digest computation:"),
    table(
