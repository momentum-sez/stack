-- SEZ Stack Persistence Layer — Initial Migration
--
-- These tables store SEZ-Stack-owned state: corridor lifecycle, smart assets,
...
-- msez-mass-client. See CLAUDE.md Section II.
