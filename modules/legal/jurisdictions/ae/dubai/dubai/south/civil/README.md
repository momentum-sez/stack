# UAE - Dubai - Dubai World Central (Dubai South) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Dubai - Dubai World Central (Dubai South)** (`ae-dubai-dubai-south`).
