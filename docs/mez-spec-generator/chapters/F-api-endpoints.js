...
module.exports = function build_appendixF() {
  return [
    ...
    p("The five Mass primitives are deployed Java/Spring Boot services. The EZ Stack communicates with these exclusively through the mez-mass-client crate. Direct HTTP calls from any other crate are forbidden by architectural invariant (INV-2, Appendix E)."),
    table(
      ...
      [
        ...
        ["Investment Info", "investment-info.api.mass.inc", "https://investment-info.api.mass.inc/investment-info/swagger-ui/index.html"],
        ...
        ["Templating Engine", "templating-engine.api.mass.inc", "https://templating-engine.api.mass.inc/templating-engine/swagger-ui/index.html"],
      ],
      [2000, 3400, 3960]
    ),

    h2("F.2 EZ Stack API Routes (mez-api, Axum)"),
    p("The EZ Stack exposes its own HTTP API via mez-api. These routes compose compliance evaluation, Mass API orchestration, credential issuance, and corridor management into jurisdiction-aware operations."),
