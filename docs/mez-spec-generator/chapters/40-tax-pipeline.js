...
module.exports = function build_chapter40() {
  return [
    ...
    p("The following table lists representative withholding tax rates under the Income Tax Ordinance 2001 as applicable to transactions processed through Mass Fiscal. Rates shown are for tax year 2024\u201325 (Pakistan fiscal year July\u2013June) and are subject to amendment by Finance Act or SRO. The MEZ Pack Trilogy maintains the authoritative rate table; regpack updates propagate new rates without code redeployment."),

    table(
      ["ITO Section", "Payment Category", "Filer Rate", "Non-Filer Rate", "Collection Point"],
      [
        ["148", "Import of goods", "1-6% (value-dependent)", "2-9% (value-dependent)", "At customs clearance via PSW integration"],
