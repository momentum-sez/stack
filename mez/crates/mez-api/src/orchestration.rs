...
//!    `mez-mass-client` (the sole authorized gateway to Mass APIs).
//!
...
//! ## Architecture
//!
//! This module is the EZ Stack's core value-add. Without it, Mass is a
...
pub mod vc_types {
    pub const FORMATION_COMPLIANCE: &str = "MezFormationComplianceCredential";
    pub const OWNERSHIP_COMPLIANCE: &str = "MezOwnershipComplianceCredential";
    pub const FISCAL_COMPLIANCE: &str = "MezFiscalComplianceCredential";
    pub const PAYMENT_COMPLIANCE: &str = "MezPaymentComplianceCredential";
    pub const IDENTITY_COMPLIANCE: &str = "MezIdentityComplianceCredential";
    pub const CONSENT_COMPLIANCE: &str = "MezConsentComplianceCredential";
}
...
pub fn issue_compliance_vc(
    ...
    let mut vc = VerifiableCredential {
        ...
        id: Some(format!("urn:mez:vc:{vc_type}:{}", Uuid::new_v4())),
        ...
        None => {
            ...
            tracing::warn!(
                ...
                "Mass API response missing 'id' field — using generated fallback. \
                 This may indicate schema drift between EZ Stack and Mass API.",
            );
            fallback
        }
    }
...
mod tests {
    ...
    fn orchestrate_entity_creation_produces_envelope() {
        ...
        let envelope =
            orchestrate_entity_creation(&state, "pk-ez-01", "Test Corp", mass_response.clone());
