# United States - Massachusetts — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **United States - Massachusetts** (`us-ma`).
