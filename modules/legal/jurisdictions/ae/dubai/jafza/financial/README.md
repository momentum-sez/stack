# UAE - Dubai - Jebel Ali Free Zone (JAFZA) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Jebel Ali Free Zone (JAFZA)** (`ae-dubai-jafza`).
