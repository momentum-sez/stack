# United States - Northern Mariana Islands — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **United States - Northern Mariana Islands** (`us-mp`).
