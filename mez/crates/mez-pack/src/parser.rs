...
//! floats, non-string keys. The EZ Stack's reproducibility depends on
...
/// implementation per CLAUDE.md §V.5. Used for content-addressing raw file
/// bytes (YAML, XML) that cannot pass through JSON canonicalization.
pub fn sha256_hex(data: &[u8]) -> String {
    mez_core::sha256_raw(data)
}
