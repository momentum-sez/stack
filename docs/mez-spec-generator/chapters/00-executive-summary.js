  ...
  return [
    ...
    table(
      ...
      [
        ...
        ["Mass/MEZ Client", "New crate", "Typed HTTP client for all five Mass primitives, NADRA adapter, contract tests"],
    ...
    table(
      ...
      [
        ["I", "Foundation", "1\u20132", "Mission, vision, programmable institution thesis, high-level architecture, system boundary between Mass and the EZ Stack"],
        ...
        ["XIII", "Mass API Integration", "37", "The mez-mass-client crate, JurisdictionalContext trait, typed client mapping to all five Mass primitives"],
