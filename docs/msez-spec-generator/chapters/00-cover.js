...
module.exports = function build_cover() {
  return [
    ...
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 120 }, children: [
      new TextRun({ text: "Open Source SEZ Stack", font: C.SUBTITLE_FONT, size: 32, italics: true, color: C.SECONDARY_TEXT })
    ]}),
    ...
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 40 }, children: [
      new TextRun({ text: "Complete SEZ-in-a-Box: Multi-Jurisdiction Composition", font: C.BODY_FONT, size: C.BODY_SIZE, italics: true, color: C.DARK })
    ]}),
    new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 60 }, children: [
