# UAE - Dubai - Dubai Knowledge Park (DKP) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Dubai - Dubai Knowledge Park (DKP)** (`ae-dubai-dkp`).
