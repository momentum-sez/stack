...
module.exports = function build_appendixA() {
  return [
    ...
    p(
      "The EZ Stack specification has evolved through four distinct phases over eighteen months. " +
      ...
      "separation of Mass primitives from EZ Stack orchestration, the port from Python to pure Rust, " +
    ...
    table(
      ...
      [
        ["0.4.44", "Feb 2026", "GENESIS", "Licensepacks, Composition Engine, Corporate/Identity/Tax/Markets/Trade modules, One-click deployment, Rust migration, Mass/MEZ separation, GovOS architecture, live corridors"],
