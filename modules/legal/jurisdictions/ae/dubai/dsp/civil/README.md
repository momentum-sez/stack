# UAE - Dubai - Dubai Science Park (DSP) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Dubai - Dubai Science Park (DSP)** (`ae-dubai-dsp`).
