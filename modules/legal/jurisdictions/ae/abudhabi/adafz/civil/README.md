# UAE - Abu Dhabi - Abu Dhabi Airports Free Zone (ADAFZ) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Abu Dhabi - Abu Dhabi Airports Free Zone (ADAFZ)** (`ae-abudhabi-adafz`).
