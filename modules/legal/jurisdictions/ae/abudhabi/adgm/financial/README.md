# UAE - Abu Dhabi - Abu Dhabi Global Market (ADGM) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Abu Dhabi - Abu Dhabi Global Market (ADGM)** (`ae-abudhabi-adgm`).
