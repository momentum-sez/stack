# UAE - Dubai - Dubai CommerCity Free Zone (DCC) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai CommerCity Free Zone (DCC)** (`ae-dubai-dccc`).
