# UAE - Dubai - Dubai Multi Commodities Centre (DMCC) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai Multi Commodities Centre (DMCC)** (`ae-dubai-dmcc`).
