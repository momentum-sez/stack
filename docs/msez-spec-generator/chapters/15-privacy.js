...
module.exports = function build_chapter15() {
  return [
    ...
    // --- 15.4 Note Encryption ---
    h2("15.4 Note Encryption"),
    ...
    // --- 15.5 Metadata Protection ---
    h2("15.5 Metadata Protection"),
    ...
    // --- 15.6 Privacy Guarantees by Transaction Type ---
    h2("15.6 Privacy Guarantees by Transaction Type"),
    table(
