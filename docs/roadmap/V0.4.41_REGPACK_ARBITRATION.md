...
This is the "radical yahoo" release that transforms the SEZ Stack from a compliance framework into a complete trade automation platform.
...
```bash
# Ingestion
msez regpack ingest <jurisdiction> --domain <domain> --as-of-date 2026-01-15
msez regpack fetch-sanctions --sources ofac,eu,un --out sanctions.json

# Verification
msez regpack verify <regpack_path> --strict
msez regpack sanctions-check --regpack <digest> --entity <name_or_id>
...
# Freshness check
msez regpack freshness-check --corridor <corridor> --max-age 7d
```
...
INPUTS:
  - ruling_vc: MSEZArbitrationRulingCredential
...
corridor_id: org.momentum.msez.corridor.arbitration.difc-lcia
...
- [ ] `msez regpack ingest`
- [ ] `msez regpack fetch-sanctions`
- [ ] `msez regpack verify`
- [ ] `msez regpack sanctions-check`
- [ ] `msez regpack attest`
- [ ] `msez corridor regpack-bind`
- [ ] `msez regpack freshness-check`
- [ ] `msez arbitration dispute-file`
- [ ] `msez arbitration evidence-submit`
- [ ] `msez arbitration ruling-verify`
- [ ] `msez arbitration ruling-enforce`
- [ ] `msez arbitration status`
