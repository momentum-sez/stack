//! Regression tests for EZ deployment bugs.
//!
...
use mez_state::corridor::{ActivationEvidence, HaltReason, SubmissionEvidence};
use mez_state::{Corridor, Draft, DynCorridorState};
use serde_json::json;
...
fn corridor_active_to_halted_to_deprecated() {
    ...
    let deprecated = halted.deprecate(mez_state::corridor::DeprecationEvidence {
