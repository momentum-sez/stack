...
module.exports = function build_chapter07() {
  return [
    ...
    p("The digital-financial-center profile targets jurisdictions seeking to establish full-service financial zones comparable to the Abu Dhabi Global Market, Dubai International Financial Centre, or Singapore's financial district. This is the most comprehensive profile in the MEZ Stack, activating all 16 module families with maximum compliance depth. It is designed for zones that will host regulated financial institutions, capital markets, fund administration, insurance underwriting, and cross-border settlement."),
    ...
    pageBreak(),
    h2("7.3 trade-hub"),
    p("The trade-hub profile targets zones focused on international trade facilitation, logistics, and supply chain management. Modeled on successful trade zones such as Jebel Ali Free Zone, Singapore Free Trade Zones, and the Shenzhen Economic Zone, this profile prioritizes customs processing, trade finance, corridor management, and supply chain documentation over capital markets and complex financial instruments. It is the appropriate choice for zones where the primary economic activity is the movement of physical goods across borders."),
    ...
    p("The sovereign-govos profile is the most demanding deployment configuration in the MEZ Stack. It transforms the Stack from a zone management system into a national operating system for government services. This profile activates all 16 module families at maximum depth, adds GovOS orchestration capabilities, and integrates with existing national government systems. It is not a zone profile in the traditional sense; it is the profile that enables a sovereign nation to operate its entire economic infrastructure through the MEZ Stack and Mass primitives."),
    ...
    p("The deployment operates across three availability zones within Pakistan (Islamabad, Lahore, Karachi) with disaster recovery in a fourth region. Each zone runs the full MEZ Stack with regional database replicas. The Experience Layer serves the GovOS Console for federal and provincial government officers, citizen portals for tax filing and business registration, and AI-powered interfaces for natural language regulatory queries."),
