# UAE - Dubai - Dubai World Central (Dubai South) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai World Central (Dubai South)** (`ae-dubai-dubai-south`).
