# UAE - Dubai - Dubai Silicon Oasis (DSO) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Dubai - Dubai Silicon Oasis (DSO)** (`ae-dubai-dso`).
