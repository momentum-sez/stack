# United Arab Emirates - Dubai (emirate) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **United Arab Emirates - Dubai (emirate)** (`ae-dubai`).
