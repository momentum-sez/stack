# UAE - Dubai - Dubai Airport Free Zone (DAFZA) — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **UAE - Dubai - Dubai Airport Free Zone (DAFZA)** (`ae-dubai-dafza`).
