...
pub enum EvidenceCategory {
    ...
    table(
      ...
      [
        ["Requested", "Claimant files dispute with monetary claim", "Escrow hold request sent to treasury-info via msez-mass-client, amount and currency recorded in dispute state"],
