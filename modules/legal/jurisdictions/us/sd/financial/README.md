# United States - South Dakota — financial corpus (placeholder)

This module is a **placeholder** for the financial legal corpus for **United States - South Dakota** (`us-sd`).
