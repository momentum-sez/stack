# UAE - Dubai - Dubai CommerCity Free Zone (DCC) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Dubai - Dubai CommerCity Free Zone (DCC)** (`ae-dubai-dccc`).
