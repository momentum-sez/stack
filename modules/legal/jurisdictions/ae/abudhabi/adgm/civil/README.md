# UAE - Abu Dhabi - Abu Dhabi Global Market (ADGM) — civil corpus (placeholder)

This module is a **placeholder** for the civil legal corpus for **UAE - Abu Dhabi - Abu Dhabi Global Market (ADGM)** (`ae-abudhabi-adgm`).
